    ...
    def test_active_goal_tree_lists_checked_in_mario_specs(self) -> None:
        ...
        self.assertEqual(
            ...
            [
                ...
                "experiments/goals/SuperMarioBros-Nes-v0/Level2-1/recipes/base.yaml",
                "experiments/goals/SuperMarioBros-Nes-v0/Level2-2/recipes/base.yaml",
                "experiments/goals/SuperMarioBros-Nes-v0/Level2-3/recipes/base.yaml",
                "experiments/goals/SuperMarioBros-Nes-v0/Level2-4/recipes/base.yaml",
                "experiments/goals/SuperMarioBros-Nes-v0/Level3-1/recipes/base.yaml",
                "experiments/goals/SuperMarioBros-Nes-v0/Level3-2/recipes/base.yaml",
                "experiments/goals/SuperMarioBros-Nes-v0/Level3-3/recipes/base.yaml",
                "experiments/goals/SuperMarioBros-Nes-v0/Level3-4/recipes/base.yaml",
                "experiments/goals/SuperMarioBros-Nes-v0/Level4-1/recipes/base.yaml",
                "experiments/goals/SuperMarioBros-Nes-v0/Level4-2/recipes/base.yaml",
                "experiments/goals/SuperMarioBros-Nes-v0/Level4-3/recipes/base.yaml",
                "experiments/goals/SuperMarioBros-Nes-v0/Level4-4/recipes/base.yaml",
                "experiments/goals/SuperMarioBros-Nes-v0/Levels_1-1_1-2/recipes/base.yaml",
                "experiments/goals/SuperMarioBros-Nes-v0/Levels_1-1_1-2/recipes/no-terminal.yaml",
            ],
        )
