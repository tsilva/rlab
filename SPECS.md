...
- `stable-retro-turbo` must preserve ROM identity, save-state starts, observations, raw signals, and engine termination consistently across training, evaluation, and playback. Version `1.0.1.post17` is the minimum supported release because it provides disabled autoreset and masked lane reset.
